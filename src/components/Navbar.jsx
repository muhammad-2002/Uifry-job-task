...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <nav className=" flex lg:flex-row   flex-col  lg:w-[1090px] lg:h-[60px] lg:justify-between lg:items-center my-5  mt-8 lg:px-0 px-1 w-full">
      ...
      >
        ...
        <div className=" w-[180px] h-[60px]  rounded flex items-center bg-primary-black text-primary-white dark:text-primary-black dark:bg-primary-white justify-center text-[18px]  font-[ClashDisplay-Medium] hover:bg-primary-red dark:hover:bg-primary-red ease-linear transition-all cursor-pointer ">
